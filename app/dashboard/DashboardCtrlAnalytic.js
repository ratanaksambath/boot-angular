...
angular.module('app.dashboard').controller('DashboardCtrlAnalytic', function ($scope, $interval, CalendarEvent) {
    ...
    $scope.$watch('autoUpdate', function(autoUpdate){
        ...
        if(autoUpdate){
            updateInterval = $interval(function(){
                ...
                var statsBot = _.rest($scope.liveStats[1]).map(function(elem, i){
                    elem[0] = i;
                    return elem;
                });
                stats.push([199, _.last(stats)[1]]);
                statsBot.push([199, _.last(statsBot)[1]]);
                $scope.liveStats = [stats,statsBot];
            }, 1500)
        } else {
    ...
    $scope.liveStats = [getFakeData(),getFakeData()];
    ...
    var turns = [[1354586000000, 153], [1364587000000, 658], [1374588000000, 198], [1384589000000, 663], [1394590000000, 801], [1404591000000, 1080], [1414592000000, 353], [1424593000000, 749], [1434594000000, 523], [1444595000000, 258], [1454596000000, 688], [1464597000000, 364]],
        expects = [[1354586000000, 53], [1364587000000, 65], [1374588000000, 98], [1384589000000, 83], [1394590000000, 980], [1404591000000, 808], [1414592000000, 720], [1424593000000, 674], [1434594000000, 23], [1444595000000, 79], [1454596000000, 88], [1464597000000, 36]],
        results = [[1354586000000, 47], [1364587000000, 435], [1374588000000, 784], [1384589000000, 346], [1394590000000, 487], [1404591000000, 463], [1414592000000, 479], [1424593000000, 236], [1434594000000, 843], [1444595000000, 657], [1454596000000, 241], [1464597000000, 341]];
